...
## [2026-09-02] ingest | Dücane Cündioğlu Kitap Önerileri + Analiz

Özet: Kullanıcının yapıştırdığı 80+ maddelik kitap önerisi listesi (Dücane Cündioğlu, Google Drive + sosyal medya derlemesi, 11 kategori: Felsefe, Din/Tasavvuf/Kelam, Siyaset/Hukuk/Tarih, Bilim/Matematik, Sanat/Edebiyat, Tarih/Medeniyet, Mimarlık, Hegel/Marx, İlkçağ, Psikoloji/Sosyoloji, Ahlak) `wiki/sources/ducane-cundioglu-kitap-onerileri.md` olarak kaydedildi. Ardından eksik/fazla/fayda/niyet analizi `wiki/synthesis/ducane-cundioglu-kitap-onerileri-analiz.md`'de yazıldı. Ana bulgular: (1) niyet — birincil metin ısrarı, disiplinler arası bütünlük, "aydın çok entelektüel yok" eleştirisi, çeviri açığına dikkat; (2) fayda — yayınevi/yıl bilgisi ve gerekçeli notlarla motive edici ama sıralama/müfredat yok, seviye homojen şekilde yüksek; (3) eksikler — kadın yazar yok denecek kadar az, çağdaş analitik felsefe yok, Doğu felsefeleri yok, güncel bilim/teknoloji/AI ve çağdaş edebiyat eksik; (4) fazlalıklar — İbn Haldun *Mukaddime* iki kez, Aristoteles aşırı temsil, Rousseau üç bölüme dağılmış, Felsefe/Din-Tasavvuf kategorileri örtüşüyor. Bu içerik İngilizce öğrenme kapsamı dışında, referans amaçlı tutuluyor. Dokunulan sayfalar: index.md (yeni "Kişisel Okuma Listeleri" bölümü), log.md.
